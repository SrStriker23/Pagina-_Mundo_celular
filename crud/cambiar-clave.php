...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        <script>
        function login(){
            var respuesta=confirm("seras redirigido a la pagina de login");
            return respuesta
        }
        </script>
        <header class="header">
        ...
        <nav class="navegador">
            <nav>
                <a class="linkeado" href="login.php">Iniciar sesion</a>
            </nav>
        </nav>
            <div class="carrusel ">
            ...
            <div class="form-login m-auto pt-4 d-flex justify-content-center align-items-center flex-column" style="height:300px; width:95%; background-color:#B2B2B2;">
                ...
                <form class="d-flex justify-content-center align-items-center flex-column my-3" action="cambiar-clave2.php" method="post" class="row g-3" autocomplete="off">
                    <div class="">
                        <input class="form-control my-3" type="password" name="contraseña" placeholder="Nueva contraseña" required>
                        <input type="hidden" name="email" value="<?=$email?>">
                    </div>
                    <div class="mb-3 my-3">
                        <button onclick="return login()" type="submit" name="btnclave" class="btn btn-dark">Continuar</button>
                    </div>
        ...
        <footer class="footer">
            <p>&copy;2023 Vicente Jaramillo Contreras</p>
        </footer>
